  ...
  return (
    <>
      <div className=" flex flex-col shadow-lg w-full h-full bg-gray-100 dark:bg-gray-800 mx-auto overflow-hidden">
        ...
        <div className="bg-blue-900 img-container w-9/12 h-full absolute right-0 shadow-lg">
        ...
        <div
          className="relative w-3/12 flex flex-col space-y-6 justify-start p-8 overflow-auto"
          style={{ scrollbarWidth: "none" }}
        >
           <CloseButton classNames="absolute right-8" onClick={closeDetail} />
